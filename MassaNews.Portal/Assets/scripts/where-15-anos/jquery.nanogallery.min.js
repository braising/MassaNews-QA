...
// sImg+='<img class="image nGEvent" src="" alt=" " style="background-image:url('+G.I[imageIdx].responsiveURL()+');visibility:visible;opacity:0;position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;zoom:1;" itemprop="contentURL">';
      ...
      // var $shareB = jQuery('.trigger-share-where');
      ...
      // $(document).on('touchstart click', '.trigger-share-where', function (e){
    ...
    function ToolbarAddElt( elt, index ) {
      ...
      switch( e ) {
        ...
        case 'vote':
          ...
          //$.get('/promocao/where-15-anos/getscore', { id: G.I[index].ID }, function (data) {

          //  $('.vote').html($('<a href="#" class="trigger-where-teste c-button-where c-button--small"><i class="fa fa-thumbs-o-up"></i> &nbsp;Votar (' + data + ')</a><div class="share"><a href="#" class="trigger-share-where" data-social="whatsapp"><i class="fa fa-whatsapp fa-2x"></i></a> <a href="#" class="trigger-share-where" data-social="facebook"><i class="fa fa-facebook-square fa-2x"></i></a> <a href="#" class="trigger-share-where" data-social="twitter"><i class="fa fa-twitter-square fa-2x"></i></a> <a href="#" class="trigger-share-where" data-social="google-plus"><i class="fa fa-google-plus-square fa-2x"></i></a></div>'));
        ...
        default:
          if( e.indexOf('custom') == 0 ) {
            ...
            //r='<div class="vote"><a href="#" class="trigger-where-teste c-button-where c-button--small"><i class="fa fa-share-square-o"></i> &nbsp;Share</a></div>';
          }
          break;
      }
      return r;
    ...
    function DisplayInternalViewerToolbar(imageIdx)
    {
        ...
        FB.getLoginStatus(function (response) {
          if (response.status === 'connected') {
            FB.api('/me', function (response) {
              $.get('/promocao/where-15-anos/voted', { facebookId: response.id, imageId: G.I[imageIdx].ID }, function (data) {
                if (data == 'ok') {
                  // Já votou
                  $('.vote').html($('<button data-img="' + G.I[imageIdx].ID + '" class="trigger-btn-votado c-button-white c-button--small"><i class="fa fa-check"></i> &nbsp;Votado</button><div class="share"><a href="#" class="trigger-share-where share-whatsapp" data-social="whatsapp"><i class="fa fa-whatsapp fa-2x"></i></a> <a href="#" class="trigger-share-where share-facebook" data-social="facebook"><i class="fa fa-facebook-square fa-2x"></i></a> <a href="#" class="trigger-share-where share-twitter" data-social="twitter"><i class="fa fa-twitter-square fa-2x"></i></a> <a href="#" class="trigger-share-where share-google-plus" data-social="google-plus"><i class="fa fa-google-plus-square fa-2x"></i></a></div>'));
                }
                else {
                  // Votar
                  $('.vote').html($('<button data-img="' + G.I[imageIdx].ID + '" class="trigger-where-teste c-button-where c-button--small"><i class="fa fa-thumbs-o-up"></i> &nbsp;Votar com o Facebook</button><div class="share"><a href="#" class="trigger-share-where share-whatsapp" data-social="whatsapp"><i class="fa fa-whatsapp fa-2x"></i></a> <a href="#" class="trigger-share-where share-facebook" data-social="facebook"><i class="fa fa-facebook-square fa-2x"></i></a> <a href="#" class="trigger-share-where share-twitter" data-social="twitter"><i class="fa fa-twitter-square fa-2x"></i></a> <a href="#" class="trigger-share-where share-google-plus" data-social="google-plus"><i class="fa fa-google-plus-square fa-2x"></i></a></div>'));
                }
              });
            });
          }
      ...
      {
        $('.vote').html($('<button data-img="' + G.I[imageIdx].ID + '" class="c-button-white c-button--small"><i class="fa fa-check"></i> &nbsp;Encerrado</button><div class="share"><a href="#" class="trigger-share-where share-whatsapp" data-social="whatsapp"><i class="fa fa-whatsapp fa-2x"></i></a> <a href="#" class="trigger-share-where share-facebook" data-social="facebook"><i class="fa fa-facebook-square fa-2x"></i></a> <a href="#" class="trigger-share-where share-twitter" data-social="twitter"><i class="fa fa-twitter-square fa-2x"></i></a> <a href="#" class="trigger-share-where share-google-plus" data-social="google-plus"><i class="fa fa-google-plus-square fa-2x"></i></a></div>'));
      }
    }
