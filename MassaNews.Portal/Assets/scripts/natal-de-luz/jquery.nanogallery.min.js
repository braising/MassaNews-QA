...
// sImg+='<img class="image nGEvent" src="" alt=" " style="background-image:url('+G.I[imageIdx].responsiveURL()+');visibility:visible;opacity:0;position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;zoom:1;" itemprop="contentURL">';
      ...
      // CUSTOM WHERE INIT
      // var $voteB = jQuery('.trigger-where-teste');
      // var $shareB = jQuery('.trigger-share-natal-de-luz');

      //$voteB.on("touchstart click",function(e){
      // $(document).on('touchstart click', '.trigger-where-teste', function (e){
      //   //alert('voto 1');
      //   //$voteB.on( (G.isIOS ? "touchstart" : "click") ,function(e){     // IPAD
      //   //e.preventDefault();
      //   e.stopPropagation();
      //   alert('voto 2');
      // });

      // $(document).on('touchstart click', '.trigger-share-natal-de-luz', function (e){
      // //$shareB.on("touchstart click",function(e){
      //   //alert('share 1');
      //   //$shareB.on( (G.isIOS ? "touchstart" : "click") ,function(e){     // IPAD
      //   //e.preventDefault();
      //   e.stopPropagation();
      //   alert('share 2');
      // });
      ...
      {
        sTB += ToolbarAddElt(tstd[i], imageIdx);
      }
      ...
      for( var i=0, lmin=tmin.length; i<lmin; i++) {
        if( G.O.viewerToolbar.standard.indexOf(tmin[i]) == -1 ) {
          sTB += ToolbarAddElt(tmin[i], imageIdx);
        }
      }
      sTB+='</div></div>';
    ...
    function ToolbarAddElt( elt, index ) {
      var r='',
      ...
      switch( e ) {
        ...
        case 'vote':
          ...
          r = '<div class="vote"></div>';
          $('.vote').html($('<a href="#" class="trigger-where-teste t-page-button c-button--small"><i class="fa fa-thumbs-o-up"></i> &nbsp;Votar</a><div class="share"><a href="#" class="trigger-share-natal-de-luz" data-social="whatsapp"><i class="fa fa-whatsapp fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz" data-social="facebook"><i class="fa fa-facebook-square fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz" data-social="twitter"><i class="fa fa-twitter-square fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz" data-social="google-plus"><i class="fa fa-google-plus-square fa-2x"></i></a></div>'));

          // $.get('/natal-de-luz/getscore', { id: G.I[index].ID }, function (data) {
          //  //$('.vote').html($('<a href="#" class="trigger-where-teste t-page-button c-button--small"><i class="fa fa-thumbs-o-up"></i> &nbsp;Votar (' + data + ')</a><div class="share"><a href="#" class="trigger-share-natal-de-luz" data-social="whatsapp"><i class="fa fa-whatsapp fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz" data-social="facebook"><i class="fa fa-facebook-square fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz" data-social="twitter"><i class="fa fa-twitter-square fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz" data-social="google-plus"><i class="fa fa-google-plus-square fa-2x"></i></a></div>'));
          // });
        ...
        default:
          if( e.indexOf('custom') == 0 ) {
            ...
            //r='<div class="vote"><a href="#" class="trigger-where-teste t-page-button c-button--small"><i class="fa fa-share-square-o"></i> &nbsp;Share</a></div>';
          }
          break;
      }
      return r;
    ...
    function DisplayInternalViewerToolbar(imageIdx)
    {
      ...
      if ($('#hdFinished').val() == 'aberto')
      {
        FB.getLoginStatus(function (response) {
          if (response.status === 'connected') {
            FB.api('/me', function (response) {
              $.get('/natal-de-luz/voted', { facebookId: response.id, imageId: G.I[imageIdx].ID }, function (data) {
                if (data == 'ok') {
                  // Já votou
                  $('.vote').html($('<button data-img="' + G.I[imageIdx].ID + '" class="trigger-btn-votado c-button-white c-button--small"><i class="fa fa-check"></i> &nbsp;Votado</button><div class="share"><a href="#" class="trigger-share-natal-de-luz share-whatsapp" data-social="whatsapp"><i class="fa fa-whatsapp fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz share-facebook" data-social="facebook"><i class="fa fa-facebook-square fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz share-twitter" data-social="twitter"><i class="fa fa-twitter-square fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz share-google-plus" data-social="google-plus"><i class="fa fa-google-plus-square fa-2x"></i></a></div>'));
                }
                else {
                  // Votar
                  $('.vote').html($('<button data-img="' + G.I[imageIdx].ID + '" class="trigger-where-teste t-page-button c-button--small"><i class="fa fa-thumbs-o-up"></i> &nbsp;Votar com o Facebook</button><div class="share"><a href="#" class="trigger-share-natal-de-luz share-whatsapp" data-social="whatsapp"><i class="fa fa-whatsapp fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz share-facebook" data-social="facebook"><i class="fa fa-facebook-square fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz share-twitter" data-social="twitter"><i class="fa fa-twitter-square fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz share-google-plus" data-social="google-plus"><i class="fa fa-google-plus-square fa-2x"></i></a></div>'));
                }
              });
            });
          }
      ...
      {
        $('.vote').html($('<button data-img="' + G.I[imageIdx].ID + '" class="c-button-white c-button--small"><i class="fa fa-check"></i> &nbsp;Encerrado</button><div class="share"><a href="#" class="trigger-share-natal-de-luz share-whatsapp" data-social="whatsapp"><i class="fa fa-whatsapp fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz share-facebook" data-social="facebook"><i class="fa fa-facebook-square fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz share-twitter" data-social="twitter"><i class="fa fa-twitter-square fa-2x"></i></a> <a href="#" class="trigger-share-natal-de-luz share-google-plus" data-social="google-plus"><i class="fa fa-google-plus-square fa-2x"></i></a></div>'));
      }
    }
    ...
    function setElementOnTop( start, elt ) {
      ...
      highest_index++;
      jQuery(elt).css('z-index',highest_index_v2);
    };
    ...
    function set2ElementsOnTop( start, elt1, elt2 ) {
      ...
      highest_index++;
      jQuery(elt2).css('z-index',highest_index_v2+1);
      jQuery(elt1).css('z-index',highest_index_v2);
    };
